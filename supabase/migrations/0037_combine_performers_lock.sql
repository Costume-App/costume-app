...
--   * Among dropped rows holding the same key, the earliest updated_at wins. In practice this
--     means whichever was entered first: nothing in this codebase updates updated_at again after
--     a measurement's initial insert.
