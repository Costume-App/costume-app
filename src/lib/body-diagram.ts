...
export const MEASUREMENT_MARKERS: Record<string, Marker> = {
  ...
  arm_circumference: { label: "Arm", view: "front", x: 74, y: 33, line: { x1: 66, y1: 33, x2: 84, y2: 33 } },
  sleeve: { label: "Sleeve", view: "front", x: 80, y: 36, line: { x1: 66, y1: 23, x2: 86, y2: 49 } },
  wrist: { label: "Wrist", view: "front", x: 84, y: 49, line: { x1: 79, y1: 49, x2: 90, y2: 49 } },
  ...
  outseam: { label: "Outseam", view: "front", x: 30, y: 62, line: { x1: 37, y1: 43, x2: 37, y2: 95 } },
